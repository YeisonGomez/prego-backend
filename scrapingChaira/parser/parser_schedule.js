...
module.exports.schedule = function(html, callback) {
...
module.exports.scheduleDocente = function(html, callback) {
    console.log("Parseando horario...");

    $ = cheerio.load(html);
    var teacher = {
        id : $('#DisplayField1').find('div').prevObject[0].children[3].data,
        name: $('#DisplayField1').find('div').prevObject[0].children[6].data
    }
    callback(teacher);
}